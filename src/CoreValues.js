...
export const CoreValues = () => (
  <React.Fragment>
    <Jumbotron jumboClasses="about_jumbo" jumboText="CORE VALUES" />

    <h4>Accessibility</h4>
    <p>
      We are committed to making your experience working with us as accessible
      as possible. Please let us know if you need assistance or accommodations.
      Contact{" "}
    ...
    <h4>Diversity</h4>
    <p>
      We value the differences that make us unique. We share a responsibility to
      create a positive culture based on respect to safeguard equity, inclusion,
      and dignity for our team and the communities we work with.
    </p>
    <h4>Equality</h4>
    <p>
      ...
      treat each other respectfully. We do not condone descrimination/harassment
      of any kind. See our Zero Tolerance Policy below for more information.
    </p>
    ...
    <p>
      We are committed to treating every individual with dignity and respect. We
      strive to prepare the organization and our members to ensure we act
      responsibly towards the communities we work with.
    </p>
    <h4>Responsive to the needs of the community</h4>
    <p>
      We understand that the needs of Santa Cruz’s marginalized communities are
      diverse and complex. We are committed to being attentive and responsive to
      those needs to the best of our ability.
    </p>
    <h4>Responsible Stewardship</h4>
    <p>
      We recognize the responsibility of running a healthcare non profit
      organization and our impact in the community. We are committed to ensuring
      that our actions are guided by our core values and in the interest of the
      community.
    </p>
    ...
    <ul>
      <li>
        ...
        offends or humiliates the recipient, that interferes with their ability
        to work and learn or leads to adverse job-related consequences, and that
        any reasonable person ought to have known would be unwelcome. It does
        not include the legitimate exercise of supervisory authority regarding
        performance reviews, work evaluations, or valid disciplinary measures.
        It may include direct or implied threats of firing, loss of promotion or
        loss of pay raise, or may create an intimidating, hostile, or offensive
        work setting.
      </li>
      <li>
        Examples of harassment include, but are not limited to, racial or sexual
        slurs, name calling, racist or sexist jokes, negative stereotyping,
        physical assault, bullying, threats, demeaning pictures, posters and
        graffiti.
      </li>
    </ul>
    <h5>
    ...
    <h4>
      Those who are reported to have harassed a coworker will not be allowed to
      volunteer with the Santa Cruz Free Clinic. To report harassment and/or
